...
def search(request):
    ...
    #icontains é um filtro de consulta do Django que é usado para realizar buscas em campos de texto; Ele é utilizado para verificar se um determinado valor está contido em um campo de texto, independentemente de como as letras estão capitalizadas.

...
from djanfromgo import forms #classe para criar formulários personalizados
 contact.forms import ContactForm #importa o formulário personalizado criado em contact/forms.py

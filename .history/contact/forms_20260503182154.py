...
class ContactForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        self.add_error('first_name', ValidationError('O nome é obrigatório.', code='invalid'))
        
    def clean_first_name(self):
        first_name = self.cleaned_data.get('first_name')
        
        if len(first_name) < 2:
            self.add_error('first_name', ValidationError('O nome deve conter pelo menos 2 caracteres.', code=))
